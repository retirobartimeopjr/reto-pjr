...
export default function AdminPanel() {
    ...
    const renderContent = () => {
        ...
        if (activeTab === 'calendario') {
            return <CalendarManager username={username} password={password} />;
        }
            ...
            `}>
                ...
                <div className="flex-1 py-6 px-4 space-y-2 overflow-y-auto mt-16 md:mt-0">
                    ...
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition text-sm font-medium ${
                            activeTab === 'calendario' ? 'bg-brand/10 text-brand' : 'text-zinc-400 hover:text-white hover:bg-white/5'
                        }`}
                    >
                    ...
                    <button 
                        onClick={() => { setActiveTab('servidores'); setIsMobileMenuOpen(false); }}
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition text-sm font-medium ${
                            activeTab === 'servidores' ? 'bg-blue-500/10 text-blue-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'
                        }`}
                    >
                    ...
                    <button 
                        onClick={() => { setActiveTab('bartimeos'); setIsMobileMenuOpen(false); }}
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition text-sm font-medium ${
                            activeTab === 'bartimeos' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-400 hover:text-white hover:bg-white/5'
                        }`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                        Coord. V Retiro
