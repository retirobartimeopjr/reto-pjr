...
export const POST: APIRoute = async ({ request }) => {
    try {
        ...
        if (action === 'sync') {
            ...
            let queryStr = `
                SELECT 
                    id, documento_identidad, nombre_completo, edad, colegio, talla_camiseta, telefono_bartimeo,
                    acudiente1_nombre, acudiente1_telefono, acudiente2_nombre, acudiente2_telefono,
                    alergias, restriccion_alimentaria, condicion_medica, medicamentos,
                    autoriza_imagen, coordi_contactado, acudiente1_contactado, acudiente2_contactado, comentarios, correo_enviado,
            ...
            const htmlMessage = `
                <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.5; max-width: 800px;">
                    ...
                    <p style="color: #d32f2f; font-size: 18px;"><strong>¡PLAZO MÁXIMO PARA REALIZAR EL PAGO: 4 DE SEPTIEMBRE!</strong></p>
